...
#define MSK_VERSION_MAJOR    8
#define MSK_VERSION_MINOR    1
#define MSK_VERSION_BUILD    0
#define MSK_VERSION_REVISION 63
...
enum MSKiparam_enum {
  ...
  MSK_IPAR_LOG_FEAS_REPAIR                   = 41,
  MSK_IPAR_LOG_FILE                          = 42,
  MSK_IPAR_LOG_INFEAS_ANA                    = 43,
  MSK_IPAR_LOG_INTPNT                        = 44,
  MSK_IPAR_LOG_MIO                           = 45,
  MSK_IPAR_LOG_MIO_FREQ                      = 46,
  MSK_IPAR_LOG_ORDER                         = 47,
  MSK_IPAR_LOG_PRESOLVE                      = 48,
  MSK_IPAR_LOG_RESPONSE                      = 49,
  MSK_IPAR_LOG_SENSITIVITY                   = 50,
  MSK_IPAR_LOG_SENSITIVITY_OPT               = 51,
  MSK_IPAR_LOG_SIM                           = 52,
  MSK_IPAR_LOG_SIM_FREQ                      = 53,
  MSK_IPAR_LOG_SIM_MINOR                     = 54,
  MSK_IPAR_LOG_STORAGE                       = 55,
  MSK_IPAR_MAX_NUM_WARNINGS                  = 56,
  MSK_IPAR_MIO_BRANCH_DIR                    = 57,
  MSK_IPAR_MIO_CONSTRUCT_SOL                 = 58,
  MSK_IPAR_MIO_CUT_CLIQUE                    = 59,
  MSK_IPAR_MIO_CUT_CMIR                      = 60,
  MSK_IPAR_MIO_CUT_GMI                       = 61,
  MSK_IPAR_MIO_CUT_IMPLIED_BOUND             = 62,
  MSK_IPAR_MIO_CUT_KNAPSACK_COVER            = 63,
  MSK_IPAR_MIO_CUT_SELECTION_LEVEL           = 64,
  MSK_IPAR_MIO_HEURISTIC_LEVEL               = 65,
  MSK_IPAR_MIO_MAX_NUM_BRANCHES              = 66,
  MSK_IPAR_MIO_MAX_NUM_RELAXS                = 67,
  MSK_IPAR_MIO_MAX_NUM_SOLUTIONS             = 68,
  MSK_IPAR_MIO_MODE                          = 69,
  MSK_IPAR_MIO_MT_USER_CB                    = 70,
  MSK_IPAR_MIO_NODE_OPTIMIZER                = 71,
  MSK_IPAR_MIO_NODE_SELECTION                = 72,
  MSK_IPAR_MIO_PERSPECTIVE_REFORMULATE       = 73,
  MSK_IPAR_MIO_PROBING_LEVEL                 = 74,
  MSK_IPAR_MIO_RINS_MAX_NODES                = 75,
  MSK_IPAR_MIO_ROOT_OPTIMIZER                = 76,
  MSK_IPAR_MIO_ROOT_REPEAT_PRESOLVE_LEVEL    = 77,
  MSK_IPAR_MIO_VB_DETECTION_LEVEL            = 78,
  MSK_IPAR_MT_SPINCOUNT                      = 79,
  MSK_IPAR_NUM_THREADS                       = 80,
  MSK_IPAR_OPF_MAX_TERMS_PER_LINE            = 81,
  MSK_IPAR_OPF_WRITE_HEADER                  = 82,
  MSK_IPAR_OPF_WRITE_HINTS                   = 83,
  MSK_IPAR_OPF_WRITE_PARAMETERS              = 84,
  MSK_IPAR_OPF_WRITE_PROBLEM                 = 85,
  MSK_IPAR_OPF_WRITE_SOL_BAS                 = 86,
  MSK_IPAR_OPF_WRITE_SOL_ITG                 = 87,
  MSK_IPAR_OPF_WRITE_SOL_ITR                 = 88,
  MSK_IPAR_OPF_WRITE_SOLUTIONS               = 89,
  MSK_IPAR_OPTIMIZER                         = 90,
  MSK_IPAR_PARAM_READ_CASE_NAME              = 91,
  MSK_IPAR_PARAM_READ_IGN_ERROR              = 92,
  MSK_IPAR_PRESOLVE_ELIMINATOR_MAX_FILL      = 93,
  MSK_IPAR_PRESOLVE_ELIMINATOR_MAX_NUM_TRIES = 94,
  MSK_IPAR_PRESOLVE_LEVEL                    = 95,
  MSK_IPAR_PRESOLVE_LINDEP_ABS_WORK_TRH      = 96,
  MSK_IPAR_PRESOLVE_LINDEP_REL_WORK_TRH      = 97,
  MSK_IPAR_PRESOLVE_LINDEP_USE               = 98,
  MSK_IPAR_PRESOLVE_MAX_NUM_REDUCTIONS       = 99,
  MSK_IPAR_PRESOLVE_USE                      = 100,
  MSK_IPAR_PRIMAL_REPAIR_OPTIMIZER           = 101,
  MSK_IPAR_READ_DATA_COMPRESSED              = 102,
  MSK_IPAR_READ_DATA_FORMAT                  = 103,
  MSK_IPAR_READ_DEBUG                        = 104,
  MSK_IPAR_READ_KEEP_FREE_CON                = 105,
  MSK_IPAR_READ_LP_DROP_NEW_VARS_IN_BOU      = 106,
  MSK_IPAR_READ_LP_QUOTED_NAMES              = 107,
  MSK_IPAR_READ_MPS_FORMAT                   = 108,
  MSK_IPAR_READ_MPS_WIDTH                    = 109,
  MSK_IPAR_READ_TASK_IGNORE_PARAM            = 110,
  MSK_IPAR_REMOVE_UNUSED_SOLUTIONS           = 111,
  MSK_IPAR_SENSITIVITY_ALL                   = 112,
  MSK_IPAR_SENSITIVITY_OPTIMIZER             = 113,
  MSK_IPAR_SENSITIVITY_TYPE                  = 114,
  MSK_IPAR_SIM_BASIS_FACTOR_USE              = 115,
  MSK_IPAR_SIM_DEGEN                         = 116,
  MSK_IPAR_SIM_DUAL_CRASH                    = 117,
  MSK_IPAR_SIM_DUAL_PHASEONE_METHOD          = 118,
  MSK_IPAR_SIM_DUAL_RESTRICT_SELECTION       = 119,
  MSK_IPAR_SIM_DUAL_SELECTION                = 120,
  MSK_IPAR_SIM_EXPLOIT_DUPVEC                = 121,
  MSK_IPAR_SIM_HOTSTART                      = 122,
  MSK_IPAR_SIM_HOTSTART_LU                   = 123,
  MSK_IPAR_SIM_MAX_ITERATIONS                = 124,
  MSK_IPAR_SIM_MAX_NUM_SETBACKS              = 125,
  MSK_IPAR_SIM_NON_SINGULAR                  = 126,
  MSK_IPAR_SIM_PRIMAL_CRASH                  = 127,
  MSK_IPAR_SIM_PRIMAL_PHASEONE_METHOD        = 128,
  MSK_IPAR_SIM_PRIMAL_RESTRICT_SELECTION     = 129,
  MSK_IPAR_SIM_PRIMAL_SELECTION              = 130,
  MSK_IPAR_SIM_REFACTOR_FREQ                 = 131,
  MSK_IPAR_SIM_REFORMULATION                 = 132,
  MSK_IPAR_SIM_SAVE_LU                       = 133,
  MSK_IPAR_SIM_SCALING                       = 134,
  MSK_IPAR_SIM_SCALING_METHOD                = 135,
  MSK_IPAR_SIM_SOLVE_FORM                    = 136,
  MSK_IPAR_SIM_STABILITY_PRIORITY            = 137,
  MSK_IPAR_SIM_SWITCH_OPTIMIZER              = 138,
  MSK_IPAR_SOL_FILTER_KEEP_BASIC             = 139,
  MSK_IPAR_SOL_FILTER_KEEP_RANGED            = 140,
  MSK_IPAR_SOL_READ_NAME_WIDTH               = 141,
  MSK_IPAR_SOL_READ_WIDTH                    = 142,
  MSK_IPAR_SOLUTION_CALLBACK                 = 143,
  MSK_IPAR_TIMING_LEVEL                      = 144,
  MSK_IPAR_WRITE_BAS_CONSTRAINTS             = 145,
  MSK_IPAR_WRITE_BAS_HEAD                    = 146,
  MSK_IPAR_WRITE_BAS_VARIABLES               = 147,
  MSK_IPAR_WRITE_DATA_COMPRESSED             = 148,
  MSK_IPAR_WRITE_DATA_FORMAT                 = 149,
  MSK_IPAR_WRITE_DATA_PARAM                  = 150,
  MSK_IPAR_WRITE_FREE_CON                    = 151,
  MSK_IPAR_WRITE_GENERIC_NAMES               = 152,
  MSK_IPAR_WRITE_GENERIC_NAMES_IO            = 153,
  MSK_IPAR_WRITE_IGNORE_INCOMPATIBLE_ITEMS   = 154,
  MSK_IPAR_WRITE_INT_CONSTRAINTS             = 155,
  MSK_IPAR_WRITE_INT_HEAD                    = 156,
  MSK_IPAR_WRITE_INT_VARIABLES               = 157,
  MSK_IPAR_WRITE_LP_FULL_OBJ                 = 158,
  MSK_IPAR_WRITE_LP_LINE_WIDTH               = 159,
  MSK_IPAR_WRITE_LP_QUOTED_NAMES             = 160,
  MSK_IPAR_WRITE_LP_STRICT_FORMAT            = 161,
  MSK_IPAR_WRITE_LP_TERMS_PER_LINE           = 162,
  MSK_IPAR_WRITE_MPS_FORMAT                  = 163,
  MSK_IPAR_WRITE_MPS_INT                     = 164,
  MSK_IPAR_WRITE_PRECISION                   = 165,
  MSK_IPAR_WRITE_SOL_BARVARIABLES            = 166,
  MSK_IPAR_WRITE_SOL_CONSTRAINTS             = 167,
  MSK_IPAR_WRITE_SOL_HEAD                    = 168,
  MSK_IPAR_WRITE_SOL_IGNORE_INVALID_NAMES    = 169,
  MSK_IPAR_WRITE_SOL_VARIABLES               = 170,
  MSK_IPAR_WRITE_TASK_INC_SOL                = 171,
  MSK_IPAR_WRITE_XML_MODE                    = 172
};
...
#define MSK_IINF_MIO_NEAR_ABSGAP_SATISFIED_                 "MSK_IINF_MIO_NEAR_ABSGAP_SATISFIED"
#define MSK_IINF_MIO_NEAR_RELGAP_SATISFIED_                 "MSK_IINF_MIO_NEAR_RELGAP_SATISFIED"
...
#define MSK_LIINF_MIO_SIM_MAXITER_SETBACKS_                 "MSK_LIINF_MIO_SIM_MAXITER_SETBACKS"
