...
libd = {
    ...
    'linux64x86' : [ 'libmosek64.so.%s.%s'   %ver, 'libiomp5.so',    'libcilkrts.so.5',    ],
    'win64x86'   : [ 'mosek64_%s_%s.dll'     %ver, 'libiomp5md.dll', 'cilkrts20.dll',       ],
    'win32x86'   : [ 'mosek%s_%s.dll'        %ver, 'libiomp5md.dll', 'cilkrts20.dll',       ]
}
